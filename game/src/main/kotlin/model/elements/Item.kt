...
class Item(val name: String, weight: Double = .0, val takeable: Boolean = false, val containable: Boolean = false) {
    var weight = weight
        private set
    ...
    companion object {
        ...
        fun fillItems(section: model.db.entity.Section): ArrayList<Item> {
            ...
            section.items!!.forEach { bdItem ->
                val item = Item(bdItem.name!!, bdItem.weight, bdItem.takeable, bdItem.containable)
